...
plot_sergia_leg <- ggplot(filter(specimens_test, Subgroup=="Sergia"), aes(x = Body_Length, y = Eye_Diameter, color =  species_text, shape = species_text, fill = species_text)) +
  ...
  scale_shape_manual(values = shapes.sergia, name = "-sergia group") + 
  scale_color_manual(values = cols.sergia, name = "-sergia group") +
  scale_fill_manual(values = cols.sergia, name = "-sergia group") +
  theme_bw() +
  theme(legend.text = element_text(face = "italic"))
...
plot_sergestes_leg <- ggplot(filter(specimens_test, Subgroup=="Sergestes"), aes(x = Body_Length, y = Eye_Diameter, color =  species_text, shape = species_text, fill = species_text)) +
  geom_point(size = 2, alpha = 1) + 
  scale_shape_manual(values = shapes.sergestes, name = "-sergestes group") + 
  scale_color_manual(values = cols.sergestes, name = "-sergestes group") +
  scale_fill_manual(values = cols.sergestes, name = "-sergestes group") +
  theme_bw() +
  theme(legend.text = element_text(face = "italic"))
